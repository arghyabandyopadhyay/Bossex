...
public class SalesCommissionAgentPage implements Initializable {
    public BorderPane salesManagementBorderPane;
    ...
    public TableView saleCommissionAgentsTableView;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        saleCommissionAgentsTableView.setFixedCellSize(25);
        saleCommissionAgentsTableView.prefHeightProperty().bind(Bindings.size(saleCommissionAgentsTableView.getItems()).multiply(saleCommissionAgentsTableView.getFixedCellSize()).add(30));
    }
}
